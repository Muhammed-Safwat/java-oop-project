...
public class computerScience implements Department {
	...
	private final String DepatmentID="CS";
	...
	public void printDepartInfo() {
		System.out.println(this.id+") Computer Science ("+this.DepatmentID+")");	
	}
	...
	// Registar stundent courses to get name and set number and level and call printCourseToStudnet()
		@Override
		...
		// search for studnet in his level 
	...
	//  to get data from user and call delete to delte course 
